...
func RenderTriggerRules(set model.TriggerRuleSet) string {
	...
	sb.WriteString("Pre-commit, pre-push, pre-PR, and release validate the same content-bound receipt and never create a new review budget or silently start Judgment Day.\n\n")
